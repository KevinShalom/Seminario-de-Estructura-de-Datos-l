...
int main()
{
    ...
    do
    {
        ...
        fflush(stdin);
        {
            ...
            t.setladoTriangulo(lado);
            t.CalcularPerimetro();
            cout<<"Area es: "<<t.getArea()<<endl;
            cout<<"Perimetro es: "<<t.getPerimetro();
            cout<<endl;
            }
            else{
        ...
        fflush(stdin);
        {
            ...
            r.setAltura(altura);
            r.CalcularArea();
            r.setladoRectangulo(lado);
            r.setladoRectangulo2(lado2);
            r.CalcularPerimetro();
            cout<<"Perimetro es: "<<r.getPerimetro()<<endl;
            cout<<"Area es: "<<r.getArea()<<endl;
            }
            else{
            cout<<"Datos no validos..."<<endl;
            }
        ...
        fflush(stdin);
            ...
            c.setladoCuadrado(lado);
            c.CalcularPerimetro();
            cout<<"Perimetro es: "<<c.getPerimetro()<<endl;
            cout<<"Area es: "<<c.getArea()<<endl;
            }
            else{
            cout<<"Datos no validos..."<<endl;
            }
        ...
        fflush(stdin);
            ...
            p.CalcularApotema();
            p.CalcularArea();
            cout<<"Perimetro es: "<<p.getPerimetro()<<endl;
            cout<<"Area es: "<<p.getArea()<<endl;
            }
            else{
            cout<<"Datos no validos..."<<endl;
            }
